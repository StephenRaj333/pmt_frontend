...
const Dashboard = () => {
    ...
    return (
        <>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            ...
                            <a className="flex ms-2 md:me-24">
                                ...
                                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{userInfo?.name}</span>
                            </a>
                        </div>
            ...
            <div className="p-4 sm:ml-64 mt-[56px]" onClick={() => setShowDropDown(false)}>
