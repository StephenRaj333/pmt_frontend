        ...
        <nav className="nav-header">
            <div className="px-3 py-3 lg:px-5 lg:pl-3 inner">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end logo-content">  
                        ...
                        <div className="flex items-center ms-3 relative">
                            <div>
                                <button type="button" onClick={handleDropDown} className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                    ...
                                    <div className="h-8 w-8 bg-light text-[#FFF] flex items-center justify-center avatar-logo">{name?.split("").join().at(0)}</div>
                                </button>
                            </div>
                            <div className={`z-50 ${showDropDown ? "block" : "hidden"} dropdown_content absolute top-[20px] right-[-6px] my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user`}>
                                <div className="inner"   role="none"> 
                                ...
                                <ul className="signout" role="none">   
